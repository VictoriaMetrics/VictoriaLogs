...
* FEATURE: [metrics](https://docs.victoriametrics.com/victorialogs/metrics/): expose the number of [partition snapshots](https://docs.victoriametrics.com/victorialogs/#backup-and-restore) via the `vl_snapshots` metric and the number of requests to `/internal/partition/snapshot/create` via the `vl_http_requests_total{path="/internal/partition/snapshot/create"}` metric. This allows monitoring backups and detecting snapshots. See [#1815](https://github.com/VictoriaMetrics/VictoriaLogs/issues/1815).

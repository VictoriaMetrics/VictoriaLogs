...
* FEATURE: [vlselect](https://docs.victoriametrics.com/victorialogs/): add `/select/logsql/active_queries` endpoint that returns the list of currently running queries. See [#1684](https://github.com/VictoriaMetrics/VictoriaLogs/issues/1684).

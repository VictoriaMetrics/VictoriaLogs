...
* FEATURE: [data ingestion](https://docs.victoriametrics.com/victorialogs/data-ingestion/): replace per-message atomic increments with per-flush atomic updates, which improves throughput on multicore systems.

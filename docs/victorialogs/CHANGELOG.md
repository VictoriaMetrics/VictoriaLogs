...
* FEATURE: [vlagent](https://docs.victoriametrics.com/victorialogs/vlagent/): implement the `/targets` web page that shows currently processing targets including their metadata. This should improve the user experience when using `vlagent` to collect Kubernetes logs and files. See [#1391](https://github.com/VictoriaMetrics/VictoriaLogs/issues/1391).

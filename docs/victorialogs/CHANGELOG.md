...
* FEATURE: [web UI](https://docs.victoriametrics.com/victorialogs/querying/#web-ui): persist the large log load confirmation preference across browser tabs and add an option to manage it in Settings. See [#911](https://github.com/VictoriaMetrics/VictoriaLogs/issues/911). Thanks to @rajcz for [the pull request #1701](https://github.com/VictoriaMetrics/VictoriaLogs/pull/1701).

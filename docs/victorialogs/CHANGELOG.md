...
* SECURITY: [web UI](https://docs.victoriametrics.com/victorialogs/querying/#web-ui): sanitize rendered HTML and Markdown in log messages and autocomplete descriptions to prevent cross-site scripting (XSS) attacks.

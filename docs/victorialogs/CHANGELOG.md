...
* BUGFIX: [web UI](https://docs.victoriametrics.com/victorialogs/querying/#web-ui): fix border colors in the light color scheme when the browser's preferred theme is dark. See [#1473](https://github.com/VictoriaMetrics/VictoriaLogs/issues/1473).

...
* BUGFIX: [web UI](https://docs.victoriametrics.com/victorialogs/querying/#web-ui): preserve set tenant while switching between VMUI tabs. See [#1447](https://github.com/VictoriaMetrics/VictoriaLogs/issues/1447).

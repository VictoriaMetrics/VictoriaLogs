...
* FEATURE: [web UI](https://docs.victoriametrics.com/victorialogs/querying/#web-ui): add an optional "Show field names" switch to Group view settings, which prefixes each displayed field value with its field name. See [#1632](https://github.com/VictoriaMetrics/VictoriaLogs/issues/1632).

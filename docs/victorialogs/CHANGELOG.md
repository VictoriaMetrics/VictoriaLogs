...
* FEATURE: [LogsQL](https://docs.victoriametrics.com/victorialogs/logsql/): add [`json_array_values` pipe](https://docs.victoriametrics.com/victorialogs/logsql/#json_array_values-pipe) for extracting values of the given field from JSON objects stored in a JSON array at the given [log field](https://docs.victoriametrics.com/victorialogs/keyconcepts/#data-model). See [#1370](https://github.com/VictoriaMetrics/VictoriaLogs/issues/1370).

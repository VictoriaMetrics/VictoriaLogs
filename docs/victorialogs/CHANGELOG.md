...
* FEATURE: [web UI](https://docs.victoriametrics.com/victorialogs/querying/#web-ui): show older logs above and newer logs below the target log in the `Log context` modal.
* FEATURE: [web UI](https://docs.victoriametrics.com/victorialogs/querying/#web-ui): replace manual load controls with infinite scroll in the `Log context` modal.
* FEATURE: [web UI](https://docs.victoriametrics.com/victorialogs/querying/#web-ui): expand the `stream_context` `time_window` from `1m` to `7d` while loading context logs in the `Log context` modal. See [#1397](https://github.com/VictoriaMetrics/VictoriaLogs/issues/1397).
* FEATURE: [web UI](https://docs.victoriametrics.com/victorialogs/querying/#web-ui): warn and highlight logs with identical timestamps in the `Log context` modal.

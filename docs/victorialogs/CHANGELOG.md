...
* FEATURE: [web UI](https://docs.victoriametrics.com/victorialogs/querying/#web-ui): add stream fields and values filters sidebar. See [#1084](https://github.com/VictoriaMetrics/VictoriaLogs/issues/1084).

...
* BUGFIX: [Syslog data ingestion](https://docs.victoriametrics.com/victorialogs/data-ingestion/syslog/): properly unescape the value of the last `cef.extension.*` field in [CEF messages](https://docs.victoriametrics.com/victorialogs/data-ingestion/syslog/#cef). Previously the last value kept escape sequences such as `\=`, while all the other values were unescaped. See [#1730](https://github.com/VictoriaMetrics/VictoriaLogs/issues/1730).

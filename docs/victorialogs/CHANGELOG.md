...
* BUGFIX: [web UI](https://docs.victoriametrics.com/victorialogs/querying/#web-ui): display the systemd-compatible `notice`, `critical`, `alert`, and `emergency` log level labels instead of collapsing them into `info` and `fatal`. See [#1543](https://github.com/VictoriaMetrics/VictoriaLogs/issues/1543).

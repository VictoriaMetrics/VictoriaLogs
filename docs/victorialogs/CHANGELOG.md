...
* FEATURE: [LogsQL](https://docs.victoriametrics.com/victorialogs/logsql/): optimize [`sort`](https://docs.victoriametrics.com/victorialogs/logsql/#sort-pipe) followed by field transformation pipes when the query has a result limit. This reduces memory usage for such queries. See [#1601](https://github.com/VictoriaMetrics/VictoriaLogs/issues/1601).

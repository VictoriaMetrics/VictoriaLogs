...
* FEATURE: add the `-health` command-line flag for checking VictoriaLogs health from distroless containers without external HTTP clients. See [#1565](https://github.com/VictoriaMetrics/VictoriaLogs/issues/1565).

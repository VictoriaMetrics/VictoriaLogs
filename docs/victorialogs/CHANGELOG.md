...
* BUGFIX: [Loki data ingestion](https://docs.victoriametrics.com/victorialogs/data-ingestion/promtail/): properly ignore structured metadata with empty values in protobuf requests. Previously, valid requests containing structured metadata with empty values could be rejected. See [#1757](https://github.com/VictoriaMetrics/VictoriaLogs/pull/1757).

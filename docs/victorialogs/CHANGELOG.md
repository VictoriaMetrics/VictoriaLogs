...
* BUGFIX: [syslog data ingestion](https://docs.victoriametrics.com/victorialogs/data-ingestion/syslog/): prevent a panic when an incomplete RFC5424 structured data parameter ends immediately after `=`. See [#1786](https://github.com/VictoriaMetrics/VictoriaLogs/pull/1786).

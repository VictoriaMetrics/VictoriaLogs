...
* BUGFIX: [Loki data ingestion](https://docs.victoriametrics.com/victorialogs/data-ingestion/promtail/): properly ignore structured metadata with empty names or values in protobuf requests. Previously, valid requests could be rejected because proto3 omits fields containing empty strings from the wire format. See [#1757](https://github.com/VictoriaMetrics/VictoriaLogs/pull/1757).

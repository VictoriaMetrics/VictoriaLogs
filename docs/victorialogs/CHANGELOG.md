...
* FEATURE: [Datadog](https://docs.victoriametrics.com/victorialogs/data-ingestion/datadog-agent/): support Datadog ingestion paths without `/insert/datadog` path prefix.

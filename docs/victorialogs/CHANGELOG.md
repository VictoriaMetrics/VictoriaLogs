...
* FEATURE: [vlagent transformations](https://docs.victoriametrics.com/victorialogs/vlagent/transformations/): add the ability to transform incoming logs via VictoriaLogs transformations. Syntax is based on [LogsQL](https://docs.victoriametrics.com/victorialogs/logsql/) with support for conditional execution, dropping and routing of logs. See [#858](https://github.com/VictoriaMetrics/VictoriaLogs/issues/858) and [these docs](https://docs.victoriametrics.com/victorialogs/vlagent/transformations/) for details.

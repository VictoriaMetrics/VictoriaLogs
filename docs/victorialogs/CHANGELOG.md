...
* FEATURE: [Datadog](https://docs.victoriametrics.com/victorialogs/data-ingestion/datadog-agent/): support default Datadog ingestion paths such as `/api/v2/logs` and `/api/v1/validate` in addition to the existing `/insert/datadog/...` paths.

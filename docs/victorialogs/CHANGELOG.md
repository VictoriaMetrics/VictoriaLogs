...
* FEATURE: [data ingestion](https://docs.victoriametrics.com/victorialogs/data-ingestion/): update the minimum value of the `-insert.maxLineSizeBytes` flag to 2 KB. Print oversized log line contents for debugging (the log line is trimmed based on the flag value). See [this issue](https://github.com/VictoriaMetrics/VictoriaLogs/issues/430).

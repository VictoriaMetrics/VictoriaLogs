...
* FEATURE: [web UI](https://docs.victoriametrics.com/victorialogs/querying/#web-ui): seed Table view columns from the Group view "Display fields" selection when Table columns haven't been configured, so switching between views keeps the chosen fields. See [#1633](https://github.com/VictoriaMetrics/VictoriaLogs/issues/1633).

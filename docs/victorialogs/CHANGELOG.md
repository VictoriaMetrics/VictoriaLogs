...
* FEATURE: [`stats` pipe](https://docs.victoriametrics.com/victorialogs/logsql/#stats-pipe): add [`count_uniq_hll`](https://docs.victoriametrics.com/victorialogs/logsql/#count_uniq_hll-stats) function for fixed-memory HyperLogLog estimation of unique values. Useful for high-cardinality UV queries where [`count_uniq`](https://docs.victoriametrics.com/victorialogs/logsql/#count_uniq-stats) / [`count_uniq_hash`](https://docs.victoriametrics.com/victorialogs/logsql/#count_uniq_hash-stats) may OOM. Cluster usage requires upgrading both `vlselect` and `vlstorage`. See [#1414](https://github.com/VictoriaMetrics/VictoriaLogs/issues/1414).

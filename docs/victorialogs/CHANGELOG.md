...
* FEATURE: [web UI](https://docs.victoriametrics.com/victorialogs/querying/#web-ui): move auto-refresh settings from the header to the Execute button dropdown. Show the active refresh interval on the button and allow stopping auto-refresh by clicking Cancel. Remove non-functional refresh controls from the Overview page. See [#11343](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/11343).

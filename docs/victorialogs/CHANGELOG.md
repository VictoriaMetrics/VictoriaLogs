...
* FEATURE: [LogsQL](https://docs.victoriametrics.com/victorialogs/logsql/): add [`json_array_values`](https://docs.victoriametrics.com/victorialogs/logsql/#json_array_values-pipe) pipe for extracting the value of the given field from every object in a JSON array stored at a log field. See [#1370](https://github.com/VictoriaMetrics/VictoriaLogs/issues/1370).

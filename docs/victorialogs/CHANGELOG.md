...
* BUGFIX: [LogsQL](https://docs.victoriametrics.com/victorialogs/logsql/): properly handle `result_prefix` for [unpack_json](https://docs.victoriametrics.com/victorialogs/logsql/#unpack_json-pipe) and [unpack_logfmt](https://docs.victoriametrics.com/victorialogs/logsql/#unpack_logfmt-pipe) pipes. See [#671](https://github.com/VictoriaMetrics/VictoriaLogs/issues/671) for more details.

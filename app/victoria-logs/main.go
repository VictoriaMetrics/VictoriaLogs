...
var (
	...
	healthCheck = flag.Bool("health", false, "Whether to run a quick health check on the /health endpoint of a VictoriaLogs instance and exit. Can use the -httpListenAddr, -http.pathPrefix, and -tls flags.")
)

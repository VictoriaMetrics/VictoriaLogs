...
var (
	httpListenAddrs = flagutil.NewArrayString("httpListenAddr", "TCP address (e.g. :9428) or Unix domain socket (e.g. unix:/run/victoria-logs.sock) to listen for incoming http requests. "+

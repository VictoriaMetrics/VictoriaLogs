...
func TestProcessor(t *testing.T) {
	...
	expectedContents := []string{`{"_msg":"foo bar","_output_stream":"stderr","_stream":"{}","_time":"2025-10-16T15:37:36.330062387Z"}`}
	...
	expectedContents = []string{
		`{"_msg":"foo","_output_stream":"stderr","_stream":"{}","_time":"2025-10-16T15:37:36.1Z"}`,
		`{"_msg":"bar","_output_stream":"stderr","_stream":"{}","_time":"2025-10-16T15:37:36.2Z"}`,
		`{"_msg":"buz","_output_stream":"stderr","_stream":"{}","_time":"2025-10-16T15:37:36.3Z"}`,
		`{"_msg":"ping","_output_stream":"stderr","_stream":"{}","_time":"2025-10-16T15:37:36.4Z"}`,
		`{"_msg":"pong","_output_stream":"stderr","_stream":"{}","_time":"2025-10-16T15:37:36.5Z"}`,
	}
	f(in, expectedContents)
	...
	expectedContents = []string{`{"_msg":"foobar","_output_stream":"stderr","_stream":"{}","_time":"2025-10-16T15:37:36.330062387Z"}`}
	f(in, expectedContents)
	...
	expectedContents = []string{
		`{"_msg":"foobarbuz","_output_stream":"stderr","_stream":"{}","_time":"2025-10-16T15:37:36.330062387Z"}`,
		`{"_msg":"ping","_output_stream":"stderr","_stream":"{}","_time":"2025-10-16T15:37:36.4Z"}`,
		`{"_msg":"ponglast","_output_stream":"stderr","_stream":"{}","_time":"2025-10-16T15:37:36.5Z"}`,
	}
	f(in, expectedContents)
	...
	expectedContents = []string{
		`{"_msg":"2","_output_stream":"stderr","_stream":"{}","_time":"2025-10-16T15:37:36.2Z"}`,
		`{"_msg":"134","_output_stream":"stdout","_stream":"{}","_time":"2025-10-16T15:37:36.4Z"}`,
	}
	f(in, expectedContents)

	// Max log line size
	firstLine := strings.Repeat("a", maxLogLineSize/2-len("2025-10-16T15:37:36Z stderr P "))
	secondLine := strings.Repeat("b", maxLogLineSize/2-len("2025-10-16T15:37:36.330062387Z stderr F ")-26)
	in = []string{
		`2025-10-16T15:37:36Z stderr P ` + firstLine,
		`2025-10-16T15:37:36.330062387Z stderr F ` + secondLine,
	}
	expectedContents = []string{
		fmt.Sprintf(`{"_msg":%q,"_output_stream":"stderr","_stream":"{}","_time":"2025-10-16T15:37:36.330062387Z"}`, firstLine+secondLine),
	}
	f(in, expectedContents)
	...
	expectedContents = []string{`{"_msg":"complete line","_output_stream":"stderr","_stream":"{}","_time":"2025-10-16T15:37:36.4Z"}`}
	f(in, expectedContents)

...
func TestParseQuery_Success(t *testing.T) {
	...
	// reserved functions
	f(`"contains_common_case"`, `"contains_common_case"`)
	f(`"contains_common_case":a`, `"contains_common_case":a`)
	f("`contains_common_case-foo`", `"contains_common_case-foo"`)
	f("a:`contains_common_case`", `a:"contains_common_case"`)
	f("a:`contains_common_case-foo`", `a:"contains_common_case-foo"`)
	f("`contains_common_case-foo`:b", `"contains_common_case-foo":b`)
	f(`"equals_common_case"`, `"equals_common_case"`)
	f(`"equals_common_case":a`, `"equals_common_case":a`)
	f("`equals_common_case-foo`", `"equals_common_case-foo"`)
	f("a:`equals_common_case`", `a:"equals_common_case"`)
	f("a:`equals_common_case-foo`", `a:"equals_common_case-foo"`)
	f("`equals_common_case-foo`:b", `"equals_common_case-foo":b`)
	f(`"json_array_contains_any"`, `"json_array_contains_any"`)
	f(`"json_array_contains_any":a`, `"json_array_contains_any":a`)
	f("`json_array_contains_any-foo`", `"json_array_contains_any-foo"`)
	f("a:`json_array_contains_any`", `a:"json_array_contains_any"`)
	f("a:`json_array_contains_any-foo`", `a:"json_array_contains_any-foo"`)
	f("`json_array_contains_any-foo`:b", `"json_array_contains_any-foo":b`)
	f(`"eq_field"`, `"eq_field"`)
	f(`"eq_field":a`, `"eq_field":a`)
	f("`eq_field-foo`", `"eq_field-foo"`)
	f("a:`eq_field`", `a:"eq_field"`)
	f("a:`eq_field-foo`", `a:"eq_field-foo"`)
	f("`eq_field-foo`:b", `"eq_field-foo":b`)
	f(`"le_field"`, `"le_field"`)
	f(`"le_field":a`, `"le_field":a`)
	f("`le_field-foo`", `"le_field-foo"`)
	f("a:`le_field`", `a:"le_field"`)
	f("a:`le_field-foo`", `a:"le_field-foo"`)
	f("`le_field-foo`:b", `"le_field-foo":b`)
	f(`"lt_field"`, `"lt_field"`)
	f(`"lt_field":a`, `"lt_field":a`)
	f("`lt_field-foo`", `"lt_field-foo"`)
	f("a:`lt_field`", `a:"lt_field"`)
	f("a:`lt_field-foo`", `a:"lt_field-foo"`)
	f("`lt_field-foo`:b", `"lt_field-foo":b`)
	f(`"exact"`, `"exact"`)
	f(`"exact":a`, `"exact":a`)
	...
	f("`pattern_match-foo`", `"pattern_match-foo"`)
	f("a:`pattern_match`", `a:"pattern_match"`)
	f("a:`pattern_match-foo`", `a:"pattern_match-foo"`)
	f("`pattern_match-foo`:b", `"pattern_match-foo":b`)
	f(`"pattern_match_full"`, `"pattern_match_full"`)
	f(`"pattern_match_full":a`, `"pattern_match_full":a`)
	f("`pattern_match_full-foo`", `"pattern_match_full-foo"`)
	f("a:`pattern_match_full`", `a:"pattern_match_full"`)
	f("a:`pattern_match_full-foo`", `a:"pattern_match_full-foo"`)
	f("`pattern_match_full-foo`:b", `"pattern_match_full-foo":b`)
	f(`"pattern_match_prefix"`, `"pattern_match_prefix"`)
	f(`"pattern_match_prefix":a`, `"pattern_match_prefix":a`)
	f("`pattern_match_prefix-foo`", `"pattern_match_prefix-foo"`)
	f("a:`pattern_match_prefix`", `a:"pattern_match_prefix"`)
	f("a:`pattern_match_prefix-foo`", `a:"pattern_match_prefix-foo"`)
	f("`pattern_match_prefix-foo`:b", `"pattern_match_prefix-foo":b`)
	f(`"pattern_match_suffix"`, `"pattern_match_suffix"`)
	f(`"pattern_match_suffix":a`, `"pattern_match_suffix":a`)
	f("`pattern_match_suffix-foo`", `"pattern_match_suffix-foo"`)
	f("a:`pattern_match_suffix`", `a:"pattern_match_suffix"`)
	f("a:`pattern_match_suffix-foo`", `a:"pattern_match_suffix-foo"`)
	f("`pattern_match_suffix-foo`:b", `"pattern_match_suffix-foo":b`)
	f(`"range"`, `"range"`)
	f(`"range":a`, `"range":a`)
	...
	f("`seq-foo`", `"seq-foo"`)
	f("a:`seq`", `a:"seq"`)
	f("a:`seq-foo`", `a:"seq-foo"`)
	f("`seq-foo`:b", `"seq-foo":b`)
	f(`"string_range"`, `"string_range"`)
	f(`"string_range":a`, `"string_range":a`)
	f("`string_range-foo`", `"string_range-foo"`)
	f("a:`string_range`", `a:"string_range"`)
	f("a:`string_range-foo`", `a:"string_range-foo"`)
	f("`string_range-foo`:b", `"string_range-foo":b`)
	f(`"value_type"`, `"value_type"`)
	f(`"value_type":a`, `"value_type":a`)
	f("`value_type-foo`", `"value_type-foo"`)
	f("a:`value_type`", `a:"value_type"`)
	f("a:`value_type-foo`", `a:"value_type-foo"`)
	f("`value_type-foo`:b", `"value_type-foo":b`)
	f("'options'", `"options"`)
...
func TestParseQuery_Failure(t *testing.T) {
	...
	// unquoted reserved functions
	f("contains_common_case")
	f("contains_common_case:a")
	f("contains_common_case-foo")
	f("a:contains_common_case")
	f("a:contains_common_case-foo")
	f("contains_common_case-foo:b")
	f("equals_common_case")
	f("equals_common_case:a")
	f("equals_common_case-foo")
	f("a:equals_common_case")
	f("a:equals_common_case-foo")
	f("equals_common_case-foo:b")
	f("json_array_contains_any")
	f("json_array_contains_any:a")
	f("json_array_contains_any-foo")
	f("a:json_array_contains_any")
	f("a:json_array_contains_any-foo")
	f("json_array_contains_any-foo:b")
	f("eq_field")
	f("eq_field:a")
	f("a:eq_field")
	f("le_field")
	...
	f("pattern_match:a")
	f("pattern_match_full:a")
	f("pattern_match_prefix:a")
	f("pattern_match_suffix:a")
	f("a:pattern_match")
	f("a:pattern_match_full")
	f("a:pattern_match_prefix")
	f("a:pattern_match_suffix")
	f("range")
	f("range:a")
	f("range-foo")
	f("a:range")

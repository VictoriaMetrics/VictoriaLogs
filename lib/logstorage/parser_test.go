...
func TestQueryCanReturnLastNResults(t *testing.T) {
	...
	f("* | unpack_json result_prefix _", false)
	f("* | unpack_json fields (time) result_prefix _", false)
	f("* | unpack_json fields (foo) result_prefix _", true)
	f("* | unpack_json fields (tim*) result_prefix _", false)
	f("* | unpack_logfmt x", false)
	f("* | unpack_logfmt fields (_time)", false)
	f("* | unpack_logfmt result_prefix x_", true)
	f("* | unpack_logfmt result_prefix _", false)
	f("* | unpack_logfmt fields (time) result_prefix _", false)
	f("* | unpack_logfmt fields (foo) result_prefix _", true)
	f("* | unpack_logfmt fields (tim*) result_prefix _", false)

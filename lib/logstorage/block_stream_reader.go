...
func (sr *streamReaders) MustClose() {
	...
	pe.Add(fs.NewMustCloserTask(&sr.columnNamesReader))
	pe.Add(fs.NewMustCloserTask(&sr.columnIdxsReader))
	pe.Add(fs.NewMustCloserTask(&sr.metaindexReader))
	pe.Add(fs.NewMustCloserTask(&sr.indexReader))
	pe.Add(fs.NewMustCloserTask(&sr.columnsHeaderIndexReader))
	pe.Add(fs.NewMustCloserTask(&sr.columnsHeaderReader))
	pe.Add(fs.NewMustCloserTask(&sr.timestampsReader))

...
func TestSyslogParser(t *testing.T) {
	...
	f(`Sep 29 08:26:10 host CEF:1|Security|threatmanager|1.0|100|worm successfully stopped|10|msg=abc\=def spt=1232`, time.UTC, `format=rfc3164 timestamp=2024-09-29T08:26:10Z hostname=host app_name=CEF cef.version=1 cef.device_vendor=Security cef.device_product=threatmanager cef.device_version=1.0 cef.device_event_class_id=100 cef.name="worm successfully stopped" cef.severity=10 cef.extension.msg=abc=def cef.extension.spt=1232`)
	f(`Sep 29 08:26:10 host CEF:1|Security|threatmanager|1.0|100|worm successfully stopped|10|msg=a\nb\rc\\d\=e`, time.UTC, `format=rfc3164 timestamp=2024-09-29T08:26:10Z hostname=host app_name=CEF cef.version=1 cef.device_vendor=Security cef.device_product=threatmanager cef.device_version=1.0 cef.device_event_class_id=100 cef.name="worm successfully stopped" cef.severity=10 cef.extension.msg="a\nb\rc\\d=e"`)
